...
const Hero = ({ mainData }: HeroProps) => {
    ...
    return (
        <section id='home' className="relative min-h-screen w-full mx-auto overflow-hidden">
            ...
            <div className="absolute -z-10 min-h-screen h-full w-full bg-slate-50 dark:bg-slate-950 overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full bg-slate-50 dark:bg-slate-950" />
                <div className="absolute blur-[120px] top-[10%] left-[20%] w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-violet-600/30 dark:bg-violet-600/20 rounded-full pointer-events-none" />
                <div className="absolute blur-[120px] bottom-[10%] right-[20%] w-[300px] md:w-[400px] h-[300px] md:h-[400px] bg-fuchsia-600/30 dark:bg-fuchsia-600/20 rounded-full pointer-events-none" />
            </div>
            ...
            <div className="py-16 lg:py-48 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0">
                ...
                <motion.div 
                    ...
                    className="relative mx-auto lg:mx-0 mt-12 md:mt-16 lg:mt-0"
                >
                    <div className="w-56 h-56 md:w-80 md:h-80 lg:-translate-x-16">
                        <Image alt='avatar' width={1000} height={1000} className="rounded-full w-full h-full object-cover shadow-2xl" priority={true} src={heroImage} />
                    </div>

                    <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }} className="absolute grid -top-6 -left-12 lg:-top-14 lg:-left-32 w-16 h-16 md:w-20 md:h-20 bg-white/20 dark:bg-slate-800/30 backdrop-blur-md border border-white/50 dark:border-slate-700/50 rounded-full place-items-center shadow-lg hover:shadow-xl transition-shadow">
                        <Image alt='tech-stack' className="h-8 w-8 md:h-10 md:w-10 object-contain" src={techStackImages[0]} width={100} height={100} />
                    </motion.div>
                    <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} className="absolute grid top-0 -right-12 lg:-right-4 w-14 h-14 bg-white/20 dark:bg-slate-800/30 backdrop-blur-md border border-white/50 dark:border-slate-700/50 rounded-full place-items-center shadow-lg hover:shadow-xl transition-shadow">
                        <Image alt='tech-stack' className="h-8 w-8 md:h-10 md:w-10 object-contain" src={techStackImages[1]} width={100} height={100} />
                    </motion.div>
                    <motion.div animate={{ y: [0, -8, 0] }} transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut" }} className="absolute grid bottom-[4rem] md:bottom-24 -right-16 md:-right-20 lg:bottom-[8.5rem] lg:-right-12 w-12 h-12 md:w-16 md:h-16 bg-white/20 dark:bg-slate-800/30 backdrop-blur-md border border-white/50 dark:border-slate-700/50 rounded-full place-items-center shadow-lg hover:shadow-xl transition-shadow">
                        <Image alt='tech-stack' className="h-6 w-6 md:h-10 md:w-10 object-contain" src={techStackImages[2]} width={100} height={100} />
                    </motion.div>
                    <motion.div animate={{ y: [0, 12, 0] }} transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut" }} className="absolute grid -bottom-10 -right-8 lg:-bottom-0 lg:right-6 w-14 md:w-16 h-14 md:h-16 bg-white/20 dark:bg-slate-800/30 backdrop-blur-md border border-white/50 dark:border-slate-700/50 rounded-full place-items-center shadow-lg hover:shadow-xl transition-shadow">
                        <Image alt='tech-stack' className="h-10 w-10 object-contain" src={techStackImages[3]} width={100} height={100} />
                    </motion.div>
                </motion.div>
